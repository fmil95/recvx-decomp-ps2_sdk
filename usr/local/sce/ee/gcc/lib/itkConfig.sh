...
# build directory.
ITK_BUILD_LIB_SPEC='-L/usr/local/sce/ee/gcc/build/itcl/itk/unix -litk3.0'

# String to pass to linker to pick up the Itk library from its
# installed directory.
ITK_LIB_SPEC='-L/usr/local/sce/ee/gcc/lib -litk3.0'
...
ITK_SRC_DIR='/usr/local/sce/ee/gcc/src/itcl/itk'

# Path to the library name. Used for dependencies.
ITK_LIB_FULL_PATH='/usr/local/sce/ee/gcc/build/itcl/itk/unix/libitk3.0.a'
