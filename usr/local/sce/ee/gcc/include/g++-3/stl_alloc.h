...
/* CYGNUS LOCAL fche/libstdc++.dll */
/* If libio's generated _G_config.h is not used, this macro may be
   undefined.  Define it to nothing by default. */
#ifndef _G_DLLEXTERN
#define _G_DLLEXTERN
#endif
/* END CYGNUS LOCAL fche/libstdc++.dll */
...
# ifdef __DECLARE_GLOBALS_HERE
    void (* __malloc_alloc_oom_handler)() _G_DLLEXTERN = 0;
    // g++ 2.7.2 does not handle static template data members.
# else
    extern void (* __malloc_alloc_oom_handler)() _G_DLLEXTERN;
# endif
#endif
  /* END CYGNUS LOCAL fche/libstdc++.dll */
...
# endif
  ...
  /* CYGNUS LOCAL fche/libstdc++.dll */
  static char* _S_start_free _G_DLLEXTERN;
  static char* _S_end_free _G_DLLEXTERN;
  static size_t _S_heap_size _G_DLLEXTERN;
  /* END CYGNUS LOCAL fche/libstdc++.dll */
