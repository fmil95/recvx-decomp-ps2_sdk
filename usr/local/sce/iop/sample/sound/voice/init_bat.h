...
//--- ボイス初期化バッチ
sceSdBatch gBatchVoiceInit[6] = {
	{ SD_BSET_PARAM, SD_VOICE_XX|SD_VP_VOLL, 0x1fff },
	{ SD_BSET_PARAM, SD_VOICE_XX|SD_VP_VOLR, 0x1fff },
	{ SD_BSET_PARAM, SD_VOICE_XX|SD_VP_PITCH, 0x400 },
	{ SD_BSET_ADDR,  SD_VOICE_XX|SD_VA_SSA , VAG_ADDR },
	{ SD_BSET_PARAM, SD_VOICE_XX|SD_VP_ADSR1, 
			SD_ADSR1(SD_ADSR_A_EXP, 30, 14, 14) },
	{ SD_BSET_PARAM, SD_VOICE_XX|SD_VP_ADSR2, 
			SD_ADSR2(SD_ADSR_S_EXP_DEC, 52, SD_ADSR_R_EXP, 13) },
};

sceSdBatch gBatchVoiceInit2[6] = {
	{ SD_BGET_PARAM, SD_VOICE_XX|SD_VP_VOLL, 0x1fff },
	{ SD_BGET_PARAM, SD_VOICE_XX|SD_VP_VOLR, 0x1fff },
	{ SD_BGET_PARAM, SD_VOICE_XX|SD_VP_PITCH, 0x400 },
	{ SD_BGET_ADDR,  SD_VOICE_XX|SD_VA_SSA , VAG_ADDR },
	{ SD_BGET_PARAM, SD_VOICE_XX|SD_VP_ADSR1, 
			SD_ADSR1(SD_ADSR_A_EXP, 30, 14, 14) },
	{ SD_BGET_PARAM, SD_VOICE_XX|SD_VP_ADSR2, 
			SD_ADSR2(SD_ADSR_S_EXP_DEC, 52, SD_ADSR_R_EXP, 13) },
};
