...
extern long SpuAutoDMAStop (void); //spu2
extern long SpuAutoDMAGetStatus (void);  //spu2
extern void SpuSetAutoDMAAttr( short vol_l, short vol_r, short dry_on, short effect_on );
extern void SpuSetSerialInAttr( short dry_on, short effect_on );
...
extern unsigned long SpuGetNextAddr (int vNum);
...
#define SpuSetDegitalOut(x) SpuSetDigitalOut(x)
