...
extern int     sceSdVoiceTrans( short channel, u_short mode, u_char *m_addr, u_char *s_addr, u_int size );
extern int     sceSdBlockTrans( short channel, u_short mode, u_char *m_addr, u_int size, ... );
extern u_int   sceSdVoiceTransStatus (short channel, short flag);
extern u_int   sceSdBlockTransStatus (short channel, short flag);
extern void*   sceSdSetTransCallback ( u_short channel, SD_TRANS_CBProc func);
extern void*   sceSdSetIRQCallback (SD_IRQ_CBProc func);
